...
namespace TeamChallengeProject_Shop.Data.Migrations
{
    ...
    [Migration("20240404181914_UpdateCategoryEntityToProduct")]
    partial class UpdateCategoryEntityToProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TeamChallengeProject_Shop.Models.Product", b =>
                {
                    b.HasOne("TeamChallengeProject_Shop.Models.Category", "Category")
                        .WithOne("Product")
                        .HasForeignKey("TeamChallengeProject_Shop.Models.Product", "CategoryId")
